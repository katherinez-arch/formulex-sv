...
export function WaitlistForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:flex-row">
      ...
      <button
        type="submit"
        className="bg-ink px-6 py-2 font-mono text-xs uppercase tracking-widest text-paper transition-all duration-200 hover:-translate-y-0.5 hover:bg-ink/80 active:translate-y-0"
      >
        Avisarme
      </button>
    </form>
